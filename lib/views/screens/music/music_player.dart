...
class MusicPlayer extends StatefulWidget {
  ...
  const MusicPlayer({super.key, required this.songModel});
...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  Widget build(BuildContext context) {
    ...
    if (favoritesProvider.isPlaying) {
      favoritesProvider.pause();
    }
    return Stack(
      children: [
        SizedBox(
                  ...
                  children: [
                    Consumer<MusicController>(
                      builder: (context, musicController, child) {
                        ...
                        if (currentSong.id != widget.songModel.id) {
                          context.read<FavoritesProvider>().checkIfFavorite(currentSong);
                        }
                        return Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.symmetric(horizontal: 20),
                                    child: Text(
                                      currentSong.artist == "<unknown>" ? "Noma'lum ijrochi" : currentSong.artist.toString(),
                                      textAlign: TextAlign.center,
                                      style: const TextStyle(
                                        color: Colors.grey,
                                        fontSize: 15,
                              ...
                              builder: (context, value, child) {
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () => value.toggleFavorite(currentSong),
                                    child: Icon(
                                      value.isFavorite ? Icons.star_rounded : Icons.star_outline_rounded,
                                      size: 35,
                                      color: value.isFavorite ? Colors.yellow : Colors.white,
                                    ),
                                  ),
                                );
                              },
                    ...
                    StreamBuilder<Duration>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final totalDuration = musicController.audioPlayer.duration ?? Duration.zero;
                        return Column(
                          children: [
                            Slider(
                              ...
                              onChanged: (value) {
                                musicController.audioPlayer.seek(Duration(seconds: value.toInt()));
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  icon: const Image(
                                    ...
                                    height: 30,
                                    color: Colors.white,
                                    image: AssetImage("assets/icons/list_music.png"),
                                  ),
                                ),
                              ],
                            ),
